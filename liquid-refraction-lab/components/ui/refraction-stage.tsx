...
export function RefractionStage({
  ...
  subText = "INTERACTIVE REFRACTION SURFACE",
  tagline = "Move your cursor to bend the surface",
  backgroundColor = "#fafafa",
  textColor = "#1d1d1f",
  imageUrl,
}: RefractionStageProps) {
  ...
  useEffect(() => {
    ...
    // 如果提供了图片URL，直接使用图片
    const imageSource = imageUrl || generateTextImage()
